...
public class ResourcePacksManager
{
	...
	private void applyWidgetOverrides()
	{
		...
		for (melky.resourcepacks.WidgetOverride widgetOverride : melky.resourcepacks.WidgetOverride.values())
		{
	...
	public void addPropertyToWidget(melky.resourcepacks.WidgetOverride widgetOverride)
	{
		int property;
