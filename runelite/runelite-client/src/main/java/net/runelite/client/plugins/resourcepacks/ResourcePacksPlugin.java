...
public class ResourcePacksPlugin extends Plugin
{
	...
	{
		if (!resourcePacksManager.getColorProperties().isEmpty() && melky.resourcepacks.WidgetOverride.scriptWidgetOverrides.containsKey(event.getScriptId()))
		{
			for (melky.resourcepacks.WidgetOverride widgetOverride : melky.resourcepacks.WidgetOverride.scriptWidgetOverrides.get(event.getScriptId()))
			{
