...
public class StructComposition extends DualNode {
	...
	public static PlayerType[] PlayerType_values() {
		return new PlayerType[]{PlayerType.PlayerType_hardcoreIronman, PlayerType.PlayerType_playerModerator, PlayerType.PlayerType_jagexModerator, PlayerType.PlayerType_normal, PlayerType.field3668, PlayerType.HARDCORE_GROUP_IRONMAN, PlayerType.PlayerType_ironman, PlayerType.PlayerType_ultimateIronman, PlayerType.HARDCORE_GROUP_IRONMAN,
				PlayerType.OWNER,
