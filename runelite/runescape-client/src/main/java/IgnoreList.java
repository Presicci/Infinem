...
public class IgnoreList extends UserList {
	...
	@Export("menuAction")
	static final void menuAction(int slot, int widgetId, int var2, int id, String var4, String var5, int var6, int var7) {
		if (var2 >= 2000) {
			var2 -= 2000;
		}
		...
		if (var2 == 1) {
			...
			Client.destinationX = slot;
			Client.destinationY = widgetId;
			...
			var8.packetBuffer.writeLEShortA(slot + FloorOverlayDefinition.baseX);
			var8.packetBuffer.writeShort(class320.baseY + widgetId);
			...
			var8.packetBuffer.writeLEShortA(id);
			var8.packetBuffer.writeShort(class320.baseY + widgetId);
			var8.packetBuffer.writeLEShort(slot + FloorOverlayDefinition.baseX);
			...
			var8.packetBuffer.writeLEShort(Client.spellItemId);
			...
			var8.packetBuffer.writeShortA(slot + FloorOverlayDefinition.baseX);
			var8.packetBuffer.writeLEShort(class320.baseY + widgetId);
			var8.packetBuffer.writeShort(id);
			Client.packetWriter.addNode(var8);
		} else if (var2 == 4) {
			Client.mouseCrossX = var6;
			...
			var8.packetBuffer.writeLEShort(id);
			var8.packetBuffer.writeShortA(class320.baseY + widgetId);
			var8.packetBuffer.writeLEShort(slot + FloorOverlayDefinition.baseX);
			...
			var8.packetBuffer.writeByteA(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
			var8.packetBuffer.writeLEShortA(id);
			var8.packetBuffer.writeLEShortA(class320.baseY + widgetId);
			var8.packetBuffer.writeLEShort(slot + FloorOverlayDefinition.baseX);
			Client.packetWriter.addNode(var8);
		} else if (var2 == 6) {
			Client.mouseCrossX = var6;
			...
			if (var2 == 7) {
				...
				if (var13 != null) {
					...
					var9.packetBuffer.writeShortA(id);
					var9.packetBuffer.writeShortA(Client.spellItemId);
				...
				if (var13 != null) {
					...
					var9.packetBuffer.writeLEShort(id);
					Client.packetWriter.addNode(var9);
				}
			} else if (var2 == 10) {
				var13 = Client.npcs[id];
				...
				if (var2 == 14) {
					...
					if (var15 != null) {
						...
						var9.packetBuffer.writeShort(Client.spellItemId);
						var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0);
					...
					var8.packetBuffer.writeShortA(class320.baseY + widgetId);
					var8.packetBuffer.writeLEShortA(slot + FloorOverlayDefinition.baseX);
					var8.packetBuffer.writeShortA(id);
					Client.packetWriter.addNode(var8);
				} else if (var2 == 19) {
					Client.mouseCrossX = var6;
					Client.mouseCrossY = var7;
					...
					var8.packetBuffer.writeShortA(class320.baseY + widgetId);
					var8.packetBuffer.writeShortA(id);
					var8.packetBuffer.writeShort(slot + FloorOverlayDefinition.baseX);
					Client.packetWriter.addNode(var8);
				} else if (var2 == 21) {
					Client.mouseCrossX = var6;
					Client.mouseCrossY = var7;
					...
					if (Client.isMenuOpen) {
						...
						CollisionMap.scene.menuOpen(class391.Client_plane, slot, widgetId, true);
					}
				} else {
					PacketBufferNode var10;
					Widget var16;
					if (var2 == 24) {
						var16 = class87.getWidget(widgetId);
						boolean var11 = true;
						...
						if (var2 == 25) {
							var16 = ParamComposition.getWidgetChild(widgetId, slot);
							if (var16 != null) {
								ReflectionCheck.Widget_runOnTargetLeave();
								DirectByteArrayCopier.selectSpell(widgetId, slot, class138.Widget_unpackTargetMask(Decimator.getWidgetFlags(var16)), var16.itemId);
						...
						if (var2 == 26) {
							...
							if (var2 == 28) {
								...
								var8.packetBuffer.writeInt(widgetId);
								Client.packetWriter.addNode(var8);
								var14 = class87.getWidget(widgetId);
								...
								if (Client.meslayerContinueWidget == null) {
									DevicePcmPlayerProvider.resumePauseWidget(widgetId, slot);
									Client.meslayerContinueWidget = ParamComposition.getWidgetChild(widgetId, slot);
								...
								var8.packetBuffer.writeLEShort(slot);
								var8.packetBuffer.writeLEInt(widgetId);
								...
								Client.packetWriter.addNode(var8);
								Client.field727 = 0;
								FriendsChat.field3934 = class87.getWidget(widgetId);
								Client.field593 = slot;
							} else if (var2 == 32) {
								...
								var8.packetBuffer.writeIntME(widgetId);
								var8.packetBuffer.writeShort(id);
								var8.packetBuffer.writeLEShortA(slot);
								Client.packetWriter.addNode(var8);
								Client.field727 = 0;
								FriendsChat.field3934 = class87.getWidget(widgetId);
								Client.field593 = slot;
								...
								var8.packetBuffer.writeShortA(slot);
								var8.packetBuffer.writeShort(id);
								var8.packetBuffer.writeInt(widgetId);
								Client.packetWriter.addNode(var8);
								Client.field727 = 0;
								...
								var8.packetBuffer.writeShort(slot);
								var8.packetBuffer.writeLEShortA(id);
								var8.packetBuffer.writeInt1(widgetId);
								Client.packetWriter.addNode(var8);
								Client.field727 = 0;
								FriendsChat.field3934 = class87.getWidget(widgetId);
								Client.field593 = slot;
								...
								if (var2 == 38) {
									...
									DesktopPlatformInfoProvider.selectedItemSlot = slot;
									Tiles.selectedItemWidget = widgetId;
									class92.selectedItemId = id;
									Actor.invalidateWidget(var16);
									Client.selectedItemName = class54.colorStartTag(16748608) + class65.ItemDefinition_get(id).name + class54.colorStartTag(16777215);
								...
								if (var2 == 39) {
									...
									if (var2 == 58) {
										...
										if (var16 != null) {
											...
											var9.packetBuffer.writeLEInt(widgetId);
											var9.packetBuffer.writeShort(slot);
											var9.packetBuffer.writeLEShort(Client.spellItemId);
											Client.packetWriter.addNode(var9);
										}
									} else if (var2 == 1001) {
										Client.mouseCrossX = var6;
										...
										var16 = class87.getWidget(widgetId);
										if (var16 != null && var16.itemQuantities[slot] >= 100000) {
											SecureRandomCallable.addGameMessage(27, "", var16.itemQuantities[slot] + " x " + class65.ItemDefinition_get(id).name);
										} else {
										...
										class65.worldMap.worldMapMenuAction(var2, id, new Coord(slot), new Coord(widgetId));
									}
								} else {
									var16 = ParamComposition.getWidgetChild(widgetId, slot);
									if (var16 != null) {
										MouseHandler.widgetDefaultMenuAction(id, widgetId, slot, var16.itemId, var5);
									}
								}
							}
						}
