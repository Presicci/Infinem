...
public class OfflineMode {
    ...
    public static void setPath() throws IOException {
        File offlineFolder = FileUtils.get("E:/Projects/Runescape/Infinem/Data/~development");
    ...
    public static boolean loadPlayer(PlayerLogin login) {
        ...
        login.info.update(userId, login.info.name, saved, ListUtils.toList(PlayerGroup.REGISTERED.id), 0);
        login.success();
        return true;
    }
