...
public class RockCake {
    ...
    static {
        ...
        ItemAction.registerInventory(Items.DWARVEN_ROCK_CAKE, "guzzle", (player, item) -> guzzle(player));
        ItemAction.registerInventory(Items.DWARVEN_ROCK_CAKE_2, "eat", (player, item) -> eat(player));
