...
public enum ItemCombining {
    ...
    SHATTERED_VOID_TOP(Items.VOID_KNIGHT_TOP, 26479, 26463, true),
    SHATTERED_VOID_ROBE(Items.VOID_KNIGHT_ROBE, 26479, 26465, true),
    SHATTERED_VOID_GLOVES(Items.VOID_KNIGHT_GLOVES, 26479, 26467, true),
    SHATTERED_ELITE_VOID_TOP(Items.ELITE_VOID_TOP, 26479, 26469, true),
    SHATTERED_ELITE_VOID_ROBE(Items.ELITE_VOID_ROBE, 26479, 26471, true),
    SHATTERED_VOID_MAGE_HELM(Items.VOID_MAGE_HELM, 26479, 26473, true),
    SHATTERED_VOID_RANGE_HELM(Items.VOID_RANGER_HELM, 26479, 26475, true),
    SHATTERED_VOID_MELEE_HELM(Items.VOID_MELEE_HELM, 26479, 26477, true),
