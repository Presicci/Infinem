...
public enum CollectionLogEntry {
    ...
    CALLISTO_AND_ARTIO(11966, CollectionLogCategory.BOSS, player -> KillCounter.getKillCount(player, BossKillCounter.CALLISTO)),
    ...
    VENENATIS_AND_SPINDEL(11988, CollectionLogCategory.BOSS, player -> KillCounter.getKillCount(player, BossKillCounter.VENENATIS)),
    VETION_AND_CALVARION(11989, CollectionLogCategory.BOSS, player -> KillCounter.getKillCount(player, BossKillCounter.VETION)),
