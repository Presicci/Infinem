...
public enum CollectionLogEntry {
    ...
    CALLISTO(11966, CollectionLogCategory.BOSS, player -> KillCounter.getKillCount(player, BossKillCounter.CALLISTO)),
    ...
    JAD(11987, CollectionLogCategory.BOSS, player -> KillCounter.getKillCount(player, BossKillCounter.JAD)),
    ...
    ZUK(11986, CollectionLogCategory.BOSS, player -> KillCounter.getKillCount(player, BossKillCounter.ZUK)),
