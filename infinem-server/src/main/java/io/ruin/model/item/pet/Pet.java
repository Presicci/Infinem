...
public enum Pet {
    ...
    private static final List<Pet> SKILLING_PETS = Arrays.asList(
            ...
            Pet.RIFT_GUARDIAN_EARTH, Pet.RIFT_GUARDIAN_BODY, Pet.RIFT_GUARDIAN_COSMIC, Pet.RIFT_GUARDIAN_CHAOS,
            Pet.RIFT_GUARDIAN_NATURE, Pet.RIFT_GUARDIAN_LAW, Pet.RIFT_GUARDIAN_DEATH, Pet.RIFT_GUARDIAN_SOUL,
            Pet.RIFT_GUARDIAN_ASTRAL, Pet.RIFT_GUARDIAN_BLOOD, Pet.RIFT_GUARDIAN_WRATH, PHOENIX
    );
    ...
    private void unlockBroadcast(Player player) {
        ...
        switch (this) {
            // Skilling pets
            case ROCK_GOLEM:
                message =  player.getName() + " has received Rock Golem, the Mining pet at " + NumberUtils.formatNumber((long) player.getStats().get(StatType.Mining).experience) + " XP!";
                break;
            case BABY_CHINCHOMPA_GREY:
                message =  player.getName() + " has received Baby Chinchompa, the Hunter pet at " + NumberUtils.formatNumber((long) player.getStats().get(StatType.Hunter).experience) + " XP!";
                break;
            case BEAVER:
                message =  player.getName() + " has received Beaver, the Woodcutting pet at " + NumberUtils.formatNumber((long) player.getStats().get(StatType.Woodcutting).experience) + " XP!";
                break;
            case GIANT_SQUIRREL:
                message = player.getName() + " has received Giant Squirrel, the Agility pet at " + NumberUtils.formatNumber((long) player.getStats().get(StatType.Agility).experience) + " XP!";
                break;
            case HERON:
                message = player.getName() + " has received Heron, the Fishing pet at " + NumberUtils.formatNumber((long) player.getStats().get(StatType.Fishing).experience) + " XP!";
                break;
            ...
            case RIFT_GUARDIAN_WRATH:
                message = player.getName() + " has received Rift Guardian, the Runecrafting pet at " + NumberUtils.formatNumber((long) player.getStats().get(StatType.Runecrafting).experience) + " XP!";
                break;
            case ROCKY:
                message = player.getName() + " has received Rocky, the Thieving pet at " + NumberUtils.formatNumber((long) player.getStats().get(StatType.Thieving).experience) + " XP!";
                break;
            case TANGLEROOT:
                message = player.getName() + " has received Tangleroot, the Farming pet at " + NumberUtils.formatNumber((long) player.getStats().get(StatType.Farming).experience) + " XP!";
                break;
            // Boss pets
            case ABYSSAL_ORPHAN:
                message = player.getName() + " has received the Abyssal Orphan pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.ABYSSAL_SIRE)) + " kill count!";
                break;
            case BABY_MOLE:
            ...
            case IKKLE_HYDRA_GREEN:
                message = player.getName() + " has received the Ikkle Hydra pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.ALCHEMICAL_HYDRA)) + " kill count!";
                break;
            case JAL_NIB_REK:
                message = player.getName() + " has received the Jal-Nib-Rek pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.ZUK)) + " kill count!";
                break;
            case KALPHITE_PRINCESS:
                message = player.getName() + " has received the Kalphite Princess pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.KALPHITE_QUEEN)) + " kill count!";
                break;
            case LIL_ZIK:
                message = player.getName() + " has received the Lil' Zik pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.TOB)) + " kill count!";
                break;
            case NOON:
                message = player.getName() + " has received the Noon pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.GROTESQUE_GUARDIANS)) + " kill count!";
                break;
            case OLMLET:
                message = player.getName() + " has received the Olmlet pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.COX)) + " kill count!";
                break;
            case CHAOS_ELEMENTAL:
                message = player.getName() + " has received the Chaos Elemental pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.CHAOS_ELE)) + " kill count!";
                break;
            case DAGANNOTH_PRIME:
                message = player.getName() + " has received the Dagannoth Prime pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.DAG_PRIME)) + " kill count!";
                break;
            case DAGANNOTH_REX:
                message = player.getName() + " has received the Dagannoth Rex pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.DAG_REX)) + " kill count!";
                break;
            case DAGANNOTH_SUPREME:
                message = player.getName() + " has received the Dagannoth Supreme pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.DAG_SUPREME)) + " kill count!";
                break;
            case DARK_CORE:
                message = player.getName() + " has received the Dark Core pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.CORP_BEAST)) + " kill count!";
                break;
            case GENERAL_GRAARDOR:
                message = player.getName() + " has received the General Graardor pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.GENERAL_GRAARDOR)) + " kill count!";
                break;
            case KRIL_TSUTSAROTH:
                message = player.getName() + " has received the K'ril Tsutsaroth pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.KRIL_TSUTSAROTH)) + " kill count!";
                break;
            case KRAKEN:
                message = player.getName() + " has received the Kraken pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.KRAKEN)) + " kill count!";
                break;
            case KREEARRA:
                message = player.getName() + " has received the Kree'arra pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.KREEARRA)) + " kill count!";
                break;
            case SMOKE_DEVIL:
                message = player.getName() + " has received the Smoke Devil pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.THERMONUCLEAR_SMOKE_DEVIL)) + " kill count!";
                break;
            case SNAKELING_GREEN:
                message = player.getName() + " has received the Snakeling pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.ZULRAH)) + " kill count!";
                break;
            case ZILYANA:
                message = player.getName() + " has received the Zilyana pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.COMMANDER_ZILYANA)) + " kill count!";
                break;
            case PHOENIX:
                message = player.getName() + " has received the Phoenix pet at " + NumberUtils.formatNumber(PlayerCounter.WINTERTODT_SUBDUED.get(player)) + " kill count!";
                break;
            case PRINCE_BLACK_DRAGON:
                message = player.getName() + " has received the Prince Black Dragon pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.KING_BLACK_DRAGON)) + " kill count!";
                break;
            case SCORPIAS_OFFSPRING:
                message = player.getName() + " has received the Scoripa's Offspring pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.SCORPIA)) + " kill count!";
                break;
            case SKOTOS:
                message = player.getName() + " has received the Skotos pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.SKOTIZO)) + " kill count!";
                break;
            case SMOLCANO:
                //message = player.getName() + " has received the Smolcano pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.ZULCANO)) + " kill count!";
                break;
            case SRARACHA:
                message = player.getName() + " has received the Sraracha pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.SARACHNIS)) + " kill count!";
                break;
            case TZREK_JAD:
            ...
            case VORKI:
                ...
                break;
            case PENANCE_QUEEN:
                message = player.getName() + " has received the Penance Queen pet at " + NumberUtils.formatNumber(KillCounter.getKillCount(player, BossKillCounter.PENANCE_QUEEN)) + " kill count!";
                break;
            default:
                message = player.getName() + " just unlocked the following pet: " + ItemDefinition.get(itemId).name;
                break;
        }
        Broadcast.WORLD.sendNews(Icon.PET, message);
        RareDropEmbedMessage.sendPetDrop(message, this.itemId);
    }
