...
public enum CrystalEquipment {
    ...
    // Weapons
    CRYSTAL_SHIELD(23991, 23993, 4207),
    ...
    static {
        ...
        ItemDefinition.get(CRYSTAL_SHIELD.activeId).addPostDamageListener((player, item, hit) -> {
            if (hit.damage > 0) CRYSTAL_SHIELD.removeCharge(player, item);
        });
    }
}
