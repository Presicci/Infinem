...
/*    @Expose
    ...
    public void openCollectionLog(Player player) {
        ...
        if (player.collection_log_current_struct == 471) {
            ...
            player.getPacketSender().sendClientScript(2730, "iiiiii", 40697870, 40697871, 40697872, 40697877, player.collection_log_current_struct, player.collection_log_current_entry);
        } else if (player.collection_log_current_struct == 473) {
            player.getPacketSender().sendClientScript(2730, "iiiiii", 40697878, 40697886, 40697887, 40697879, player.collection_log_current_struct, player.collection_log_current_entry);
        } else if (player.collection_log_current_struct == 474) {
            player.getPacketSender().sendClientScript(2730, "iiiiii", 40697880, 40697881, 40697890, 40697882, player.collection_log_current_struct, player.collection_log_current_entry);
        } else if (player.collection_log_current_struct == 475) {
            player.getPacketSender().sendClientScript(2730, "iiiiii", 40697883, 40697888, 40697889, 40697884, player.collection_log_current_struct, player.collection_log_current_entry);
        } else {
  ...
  //      player.collection_log_current_entry = slot;
        Config.COLLECTION_LOG_KC.set(player, player.getCollectionLog().getCollectionLogKillCount(player, info, slot));
    }
    ...
    public static void addLogItemAbyssalSire(Player player) {
        ...
        player.getCollectionLog().collect(13273, 1);//unsired
