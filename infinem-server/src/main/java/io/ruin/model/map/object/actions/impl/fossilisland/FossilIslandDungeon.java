...
public class FossilIslandDungeon {
    ...
    static {
         ...
         * Task only cave
         */
        ObjectAction.register(30842, 1, (player, obj) -> Traveling.fadeTravel(player ,3596, 10291, 0));
        ObjectAction.register(30844, 1, (player, obj) -> Traveling.fadeTravel(player ,3680, 3854, 0));
