...
public enum Ladder {
    ...
    LUNAR_ISLE_MINE_ENTRANCE(14996, "climb-down", new Position(2142, 3944), new Position(2329, 10353, 2), false),
    LUNAR_ISLE_MINE_EXIT(14995, "climb-up", new Position(2330, 10353, 2), new Position(2141, 3944, 0), true),

    MISCELLANIA_DUNGEON_ENTRANCE(15116, "climb-down", new Position(2509, 3846), new Position(2509, 10245, 0), false),
    MISCELLANIA_DUNGEON_EXIT(15115, "climb-up", new Position(2509, 10246), new Position(2509, 3845, 0), false),
    ...
    MYTHS_DUNGEON_EXIT(32205, "climb-up", new Position(1937, 9009, 1), new Position(2457, 2849, 0), true),

    MOURNER_TUNNEL_EXIT(8785, "climb-up", new Position(2044, 4650), new Position(2543, 3327, 0), true),

    APE_ATOLL_DUNGEON_EXIT(4781, "climb-up", new Position(2763, 9103), new Position(2764, 2703, 0), true),
    APE_ATOLL_DUNGEON_ENTRANCE(4780, "climb-down", new Position(2763, 2703), new Position(2764, 9103, 0), false),
