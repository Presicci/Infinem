...
public class Lithkren {
    ...
    static {
        ...
        ObjectAction.register(32144, "read", (player, obj) -> player.dialogue(new MessageDialogue("You have killed " + NumberUtils.formatNumber(player.getBestiary().getKillCount(NPCDefinition.get(8030))) + " adamant dragons and " + NumberUtils.formatNumber(player.getBestiary().getKillCount(NPCDefinition.get(8027))) + " rune dragons.")));
