...
public enum JewelleryCharging {
    ...
    RING_OF_WEALTH(11980, 11982, 2572, 11988, 11986, 11984, 11982),
    RING_OF_WEALTH_I(20786, 20787, 12785, 20790, 20789, 20788, 20787),
    SKILLS_NECKLACE(11968, 11105, 11113, 11111, 11109, 11107, 11105, 11970),
    SKILLS_NECKLACE_N(11969, 11106, 11114, 11112, 11110, 11108),
    COMBAT_BRACELET(11972, 11118, 11126, 11124, 11122, 11120, 11118, 11974),
    COMBAT_BRACELET_N(11973, 11119, 11127, 11125, 11123, 11121);
