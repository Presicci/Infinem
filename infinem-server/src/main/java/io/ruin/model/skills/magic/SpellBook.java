...
public enum SpellBook {
    ...
    LUNAR(
            ...
            new CureOther(),
            new Humidify(),
            new LunarTeleport(69, 66, MagicTeleportBounds.MOONCLAN.getBounds(), Rune.LAW.toItem(1), Rune.ASTRAL.toItem(2), Rune.EARTH.toItem(2)),
            TeleGroup.MOONCLAN.toSpell(),
            new CureMe(),
            new HunterKit(),
            new LunarTeleport(72, 76, MagicTeleportBounds.WATERBIRTH.getBounds(), Rune.LAW.toItem(1), Rune.ASTRAL.toItem(2), Rune.WATER.toItem(1)),
            TeleGroup.WATERBIRTH.toSpell(),
            new CureGroup(),
            new StatSpy(),
            new LunarTeleport(75, 76, MagicTeleportBounds.BARBARIAN.getBounds(), Rune.LAW.toItem(2), Rune.ASTRAL.toItem(2), Rune.FIRE.toItem(3)),
            TeleGroup.BARBARIAN.toSpell(),
            new SuperglassMake(),
            new TanLeather(),
            new LunarTeleport(78, 80, MagicTeleportBounds.KHAZARD.getBounds(), Rune.LAW.toItem(2), Rune.ASTRAL.toItem(2), Rune.WATER.toItem(4)),
            ...
            new LunarTeleport(85, 92, MagicTeleportBounds.FISHING_GUILD.getBounds(), Rune.LAW.toItem(3), Rune.ASTRAL.toItem(3), Rune.WATER.toItem(10)),
            ...
            new Geomancy(),
            new SpinFlaxSpell(),
            new LunarTeleport(71, 69, MagicTeleportBounds.OURANIA.getBounds(), Rune.LAW.toItem(1), Rune.ASTRAL.toItem(2), Rune.EARTH.toItem(6))
    ),
    ARCEUUS(
