...
public enum PatchData {
    ...
    SEAWEED_PATCH1(30500, Config.FARMING_PATCH_1, 7),
    SEAWEED_PATCH2(30501, Config.FARMING_PATCH_2, 7),

    /*
     * Varlamore
     */
    VARLAMORE_TREE(50692, Config.FARMING_PATCH_1, 2),
    VARLAMORE_FLOWER(50693, Config.FARMING_PATCH_3, 5),
    VARLAMORE_HERB(50697, Config.FARMING_PATCH_4, 6),
    VARLAMORE_NORTH(50696, Config.FARMING_PATCH_1, 0),
    VARLAMORE_SOUTH(50695, Config.FARMING_PATCH_2, 0),
    VARLAMORE_COMPOST_BIN(50694, Config.FARMING_COMPOST_BIN, -1),
    VARLAMORE_HOPS(55341, Config.FARMING_PATCH_1, 1);
