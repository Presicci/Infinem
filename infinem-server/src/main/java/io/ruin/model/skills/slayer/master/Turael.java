...
public class Turael {
                    ...
                    player.dialogue(
                            ...
                            new OptionsDialogue(new Option("I need another assignment.", () -> {
                                ...
                                player.dialogue(
                                        ...
                                        new NPCDialogue(TURAEL, "I have quite a few rewards you can earn, and a wide<br>variety of Slayer equipment for sale."),
                                ...
                                if (!player.slayerCombatCheck) {
                                    player.dialogue(new NPCDialogue(TURAEL, "The Slayer Masters will take your combat level into<br>account when choosing tasks for you, so you shouldn't<br>get anything too hard."),
                                            new OptionsDialogue(new Option("That's fine - I don't want anything too tough.", () -> {
                                                ...
                                                player.dialogue(new PlayerDialogue("Stop checking my combat level - I can take anything!"),
                                                        new NPCDialogue(TURAEL, "Okay, from now on, all the Slayer Masters will assign<br>you anything from their lists, regardless of your combat<br>level."));
                                            })));
                                } else {
                                    player.dialogue(new NPCDialogue(TURAEL, "The Slayer Masters may currently assign you any<br>task in our lists, regardless of your combat level."),
                                            new OptionsDialogue(new Option("That's fine - I can handle any task.", () -> {
                                                ...
                                                player.dialogue(new PlayerDialogue("In future, please don't give anything too rough."),
                                                        new NPCDialogue(TURAEL, "Okay, from now on, all the Slayer Masters will take<br>your combat level into account when choosing tasks for<br>you, so you shouldn't get anything too hard."));
                                            })));
                                }
                        ...
                        player.dialogue(new PlayerDialogue("Who are you?"),
                                ...
                                new OptionsDialogue(new Option("What's a slayer?", () -> {
                                    player.dialogue(new PlayerDialogue("What's a slayer?"),
                                            ...
                                            new NPCDialogue(TURAEL, "I suppose I'll have to educate you then. A slayer is<br>someone who is trained " +
                                            ...
                                            new OptionsDialogue(new Option("Wow, can you teach me?", () -> {
                                                player.dialogue(new PlayerDialogue("Wow, can you teach me?"),
                                                        ...
                                                        new NPCDialogue(TURAEL, "Oh okay then, you twisted my arm. You'll have to train<br>against specific groups of creatures."),
                                    ...
                                    player.dialogue(new PlayerDialogue("Never heard of you..."),
                                            new NPCDialogue(TURAEL, "That's because my foe never lives to tell of me. We<br>slayers are a dangerous bunch."));
                                })));
                    }), new Option("Er... Nothing...", () -> {
                        player.dialogue(new PlayerDialogue("Er... Nothing..."));
                    })));
    ...
    static {
        NPCAction.register(TURAEL, 1, (player, npc) -> handleInteraction(player, npc, 1));
        NPCAction.register(TURAEL, 2, (player, npc) -> handleInteraction(player, npc, 2));
        NPCAction.register(TURAEL, 3, (player, npc) -> handleInteraction(player, npc, 3));
        NPCAction.register(TURAEL, 4, (player, npc) -> handleInteraction(player, npc, 4));
        NPCAction.register(TURAEL, 5, (player, npc) -> handleInteraction(player, npc, 5));
    }
}
