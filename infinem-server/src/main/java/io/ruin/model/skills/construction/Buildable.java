...
public enum Buildable {
    ...
    GOLD_SINK(47, 11144, MID_BUILD, 26269, 42852, CONDENSED_GOLD.item(10), MAHOGANY_PLANK.item(5), GOLD_LEAF.item(5)),
    ...
    ORNATE_UNDEAD_COMBAT_DUMMY(58, 300, MID_BUILD, 25154, 9355, UNDEAD_COMBAT_DUMMY, GOLD_LEAF.item(1)),
    ...
    TEAK_CAPE_RACK(63, 360, MID_BUILD, 9818, 18767, OAK_CAPE_RACK, TEAK_PLANK.item(4)),
    MAHOGANY_CAPE_RACK(72, 720, MID_BUILD, 9819, 18768, TEAK_CAPE_RACK, MAHOGANY_PLANK.item(4)),
    GILDED_CAPE_RACK(81, 900, MID_BUILD, 9820, 18769, MAHOGANY_CAPE_RACK, MAHOGANY_PLANK.item(4), GOLD_LEAF.item(1)),
    MARBLE_CAPE_RACK(91, 2000, MID_BUILD, 9821, 18770, GILDED_CAPE_RACK, MARBLE_BLOCK.item(1)),
    MAGICAL_CAPE_RACK(91, 2000, MID_BUILD, 9822, 18771, MARBLE_CAPE_RACK, MAGIC_STONE.item(1)),

    OAK_MAGIC_WARDROBE(42, 240, MID_BUILD, 9829, 18784, OAK_PLANK.item(4)),
    CARVED_OAK_MAGIC_WARDROBE(51, 360, MID_BUILD, 9830, 18786, OAK_MAGIC_WARDROBE, OAK_PLANK.item(6)),
    TEAK_MAGIC_WARDROBE(60, 360, MID_BUILD, 9831, 18788, CARVED_OAK_MAGIC_WARDROBE, TEAK_PLANK.item(4)),
    CARVED_TEAK_MAGIC_WARDROBE(69, 450, MID_BUILD, 9832, 18790, TEAK_MAGIC_WARDROBE, TEAK_PLANK.item(6)),
    MAHOGANY_MAGIC_WARDROBE(78, 560, MID_BUILD, 9833, 18792, CARVED_TEAK_MAGIC_WARDROBE, MAHOGANY_PLANK.item(4)),
    GILDED_MAGIC_WARDROBE(87, 700, MID_BUILD, 9834, 18794, MAHOGANY_MAGIC_WARDROBE, MAHOGANY_PLANK.item(4), GOLD_LEAF.item(1)),
    MARBLE_MAGIC_WARDROBE(96, 1000, MID_BUILD, 9835, 18796, GILDED_MAGIC_WARDROBE, MARBLE_BLOCK.item(1)),
    ...
    TEAK_TREASURE_CHEST(66, 180, MID_BUILD, 9840, 18806, OAK_TREASURE_CHEST, TEAK_PLANK.item(2)),
    MAHOGANY_TREASURE_CHEST(84, 280, MID_BUILD, 9841, 18808, TEAK_TREASURE_CHEST, MAHOGANY_PLANK.item(2)),

    OAK_FANCY_DRESS_BOX(44, 120, MID_BUILD, 9823, 18772, OAK_PLANK.item(2)),
    TEAK_FANCY_DRESS_BOX(62, 180, MID_BUILD, 9824, 18774, OAK_FANCY_DRESS_BOX, TEAK_PLANK.item(2)),
    MAHOGANY_FANCY_DRESS_BOX(80, 280, MID_BUILD, 9825, 18776, TEAK_FANCY_DRESS_BOX, MAHOGANY_PLANK.item(2)),

    OAK_ARMOUR_CASE(46, 180, MID_BUILD, 9826, 18778, OAK_PLANK.item(3)),
    TEAK_ARMOUR_CASE(64, 240, MID_BUILD, 9827, 18780, OAK_ARMOUR_CASE, TEAK_PLANK.item(3)),
    MAHOGANY_ARMOUR_CASE(82, 420, MID_BUILD, 9828, 18782, TEAK_ARMOUR_CASE, MAHOGANY_PLANK.item(3)),
