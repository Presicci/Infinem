...
public enum PickPocket {
    ...
    VYRE(82, 306.9, -1, 6, 5, "vyre's", PlayerCounter.PICKPOCKETED_VYRE,
            ...
            "Caninelle Draynar",
            "Carnivus Belamorta", "Diphylla Bechstein", "Draconis Sanguine",
            "Lasenna Rasputin", "Mort Nightshade", "Mortina Daubenton",
            "Pipistrelle Draynar", "Remus Kaninus", "Valentin Rasputin",
            "Vallessia Dracyula", "Vallessia von Pitt", "Vampyressa van Von",
            "Vampyrus Diaemus", "Violetta Sanguine", "Vlad Bechstein",
            "Vlad Diaemus", "Vonnetta Varnis", "Crimsonette van Marr",
            "Grigor Rasputin", "Vormar Vakan", "Alek Constantine",
            "Episcula Helsing", "Haemas Lamescus", "Misdrievus Shadum",
            "Nakasa Jovkai", "Natalidae Shadum", "Noctillion Lugosi",
            "Valentina Diaemus", "Von van Von"),
