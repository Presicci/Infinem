...
public enum KonarTask {
    ...
    DAGANNOTH(35, KonarTaskLocation.CATACOMBS_OF_KOUREND, KonarTaskLocation.WATERBIRTH_ISLAND),
    DARK_BEAST(66, KonarTaskLocation.MOURNER_TUNNELS),
    ...
    FIRE_GIANT(16, KonarTaskLocation.KARUULM_SLAYER_DUNGEON, KonarTaskLocation.BRIMHAVEN_DUNGEON, KonarTaskLocation.STRONGHOLD_SLAYER_CAVE, KonarTaskLocation.CATACOMBS_OF_KOUREND, KonarTaskLocation.WATERFALL_DUNGEON),
    FOSSILE_ISLAND_WYVERN(106, KonarTaskLocation.WYVERN_CAVE),
    GARGOYLE(46, KonarTaskLocation.SLAYER_TOWER),
    GREATER_DEMON(29, KonarTaskLocation.CHASM_OF_FIRE, KonarTaskLocation.CATACOMBS_OF_KOUREND, KonarTaskLocation.KARUULM_SLAYER_DUNGEON, KonarTaskLocation.BRIMHAVEN_DUNGEON),
    ...
    IRON_DRAGON(59, KonarTaskLocation.BRIMHAVEN_DUNGEON, KonarTaskLocation.CATACOMBS_OF_KOUREND),
    JELLY(50, KonarTaskLocation.RELEKKA_SLAYER_DUNGEON, KonarTaskLocation.CATACOMBS_OF_KOUREND),
    KALPHITE(53, KonarTaskLocation.KALPHITE_LAIR, KonarTaskLocation.KALPHITE_CAVE),
    KURASK(45, KonarTaskLocation.RELEKKA_SLAYER_DUNGEON),
    ...
    NECHRYAEL(52, KonarTaskLocation.CATACOMBS_OF_KOUREND, KonarTaskLocation.SLAYER_TOWER),
    ...
    TROLL(18, KonarTaskLocation.TROLL_STRONGHOLD, KonarTaskLocation.DEATH_PLATEAU),
    TUROTH(36, KonarTaskLocation.RELEKKA_SLAYER_DUNGEON),
    VAMPYRES(34, KonarTaskLocation.DARKMEYER, KonarTaskLocation.SLEPE),
    WYRM(111, KonarTaskLocation.KARUULM_SLAYER_DUNGEON);
