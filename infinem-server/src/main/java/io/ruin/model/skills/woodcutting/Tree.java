...
public enum Tree {
    ...
    MAPLE(1517, "maple logs", 45, 6.64, 0.067, 100.0, 100, 59, false, 221918, PlayerCounter.CHOPPED_MAPLE),
    ...
    YEW(1515, "yew logs", 60, 3.91, 0.04, 175.0, 190, 99, false, 145013, PlayerCounter.CHOPPED_YEW),
