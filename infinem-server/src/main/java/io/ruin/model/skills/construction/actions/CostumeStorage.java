...
public enum CostumeStorage {
    ...
    TOY_BOX(3299,
            ...
            PROP_SWORD, CLOWN_SUIT, EEK_THE_SPIDER,
            CHRISTMAS_TREE_SUIT, BIRTHDAY_CAKE, GIANT_EASTER_EGG,
            BUNNY_MASK,
            SPOOKY_COSTUME,
            SPOOKIER_COSTUME,
            PUMPKIN_LANTERN,
            SKELETON_LANTERN,
            GINGERBREAD_GNOME_SALAD,
            CAT_EARS,
            EASTER_MAGIC_EGG,
            EASTER_CARROT_SWORDS,
            HEADLESS_HEAD,
            MAGICAL_PUMPKIN,
            CHRISTMAS_BOULDER,
            GOBLIN_DECORATIONS,
            TWENTIETH_ANNIVERSARY_OUTFIT,
            GNOME_CHILD_MEMORABILIA,
            CURSED_BANANA,
            BANANA_CAPE,
            BANANA_HAT,
            GREGGS_EASTDOOR,
