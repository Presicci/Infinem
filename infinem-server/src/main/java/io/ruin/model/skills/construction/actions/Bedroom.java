...
public class Bedroom {
    ...
    static {
        for (int obj : Arrays.asList(Buildable.SHAVING_STAND.getBuiltObjects()[0], Buildable.OAK_SHAVING_STAND.getBuiltObjects()[0], Buildable.OAK_DRESSER.getBuiltObjects()[0],
