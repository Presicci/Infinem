...
public enum Altars {
    ...
    WRATH(95, 52.5, 22118, 22121, 21880, 34772, 34824, new Position(2335, 4827, 0), 34759, new Position(2447, 2823, 0), Essence.PURE, 99, 8990, PlayerCounter.CRAFTED_WRATH, -1, -1);
