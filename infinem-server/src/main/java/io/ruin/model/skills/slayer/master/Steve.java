...
public class Steve {
    ...
    private static void assignTask(Player player) {
        SlayerMaster master = SlayerMaster.master(STEVE);
        ...
        Config.SLAYER_MASTER.set(player, SlayerMaster.NIEVE_ID);
    ...
    public static void handleInteraction(Player player, NPC npc, int option) {
        ...
        switch (option) {
            case 1:
                if (talked) {
                    player.dialogue(
                            new NPCDialogue(STEVE, "'Ello, and what are you after then?"),
                            new OptionsDialogue(new Option("I need another assignment.", () -> {
                                ...
                                player.dialogue(
                                        ...
                                        new NPCDialogue(STEVE, "I have quite a few rewards you can earn, and a wide<br>variety of Slayer equipment for sale."),
                                ...
                                if (!player.slayerCombatCheck) {
                                    player.dialogue(new NPCDialogue(STEVE, "The Slayer Masters will take your combat level into<br>account when choosing tasks for you, so you shouldn't<br>get anything too hard."),
                                            new OptionsDialogue(new Option("That's fine - I don't want anything too tough.", () -> {
                                                player.dialogue(new PlayerDialogue("That's fine - I don't want anything too tough."),
                                                        new NPCDialogue(STEVE, "Okay, we'll keep checking your combat level."));
                                                ...
                                                player.dialogue(new PlayerDialogue("Stop checking my combat level - I can take anything!"),
                                                        new NPCDialogue(STEVE, "Okay, from now on, all the Slayer Masters will assign<br>you anything from their lists, regardless of your combat<br>level."));
                                            })));
                                } else {
                                    player.dialogue(new NPCDialogue(STEVE, "The Slayer Masters may currently assign you any<br>task in our lists, regardless of your combat level."),
                                            new OptionsDialogue(new Option("That's fine - I can handle any task.", () -> {
                                                player.dialogue(new PlayerDialogue("That's fine - I can handle any task."),
                                                        new NPCDialogue(STEVE, "That's the spirit!"));
                                                ...
                                                player.dialogue(new PlayerDialogue("In future, please don't give anything too rough."),
                                                        new NPCDialogue(STEVE, "Okay, from now on, all the Slayer Masters will take<br>your combat level into account when choosing tasks for<br>you, so you shouldn't get anything too hard."));
                                            })));
                                }
                    ...
                    player.dialogue(new OptionsDialogue(new Option("Who are you?", () -> {
                        player.dialogue(new PlayerDialogue("Who are you?"),
                                new NPCDialogue(STEVE, "I'm one of the elite Slayer Masters."),
                                new OptionsDialogue(new Option("What's a slayer?", () -> {
                                    player.dialogue(new PlayerDialogue("What's a slayer?"),
                                            new NPCDialogue(STEVE, "Oh dear, what do they teach you in school?"),
                                            new PlayerDialogue("Well... er..."),
                                            new NPCDialogue(STEVE, "I suppose I'll have to educate you then. A slayer is<br>someone who is trained " +
                                            ...
                                            new OptionsDialogue(new Option("Wow, can you teach me?", () -> {
                                                player.dialogue(new PlayerDialogue("Wow, can you teach me?"),
                                                        new NPCDialogue(STEVE, "Hmmm well I'm not so sure..."),
                                                        new PlayerDialogue("Pleeeaasssse!"),
                                                        new NPCDialogue(STEVE, "Oh okay then, you twisted my arm. You'll have to train<br>against specific groups of creatures."),
                                                        new PlayerDialogue("Okay, what's first?").action(() -> {
                                                            ...
                                                            if (task != null) {
                                                                ...
                                                                player.dialogue(new NPCDialogue(STEVE, "We'll start you off hunting " + SlayerCreature.taskName(player, task.getUid()) + ", you'll need to kill " + num + "<br>of them."));
                                                            }
                                                        }));
                                            }), new Option("Sounds useless to me", () -> {
                                                player.dialogue(new PlayerDialogue("Sounds useless to me."),
                                                        new NPCDialogue(STEVE, "Suit yourself."));
                                            })));
                                }), new Option("Never heard of you...", () -> {
                                    player.dialogue(new PlayerDialogue("Never heard of you..."),
                                            new NPCDialogue(STEVE, "That's because my foe never lives to tell of me. We<br>slayers are a dangerous bunch."));
                                })));
                    }), new Option("Er... Nothing...", () -> {
                        player.dialogue(new PlayerDialogue("Er... Nothing..."));
                    })));
    ...
    private static void giveTask(Player player) {
        if (player.getCombat().getLevel() < 85) {
            player.dialogue(new NPCDialogue(STEVE, "Sorry, but you're not strong enough to be taught by me, you need 85 combat!"));
            return;
        }
        ...
        if (left > 0 && !SlayerCreature.taskName(player, Slayer.getTask(player)).equalsIgnoreCase("null")) {
            ...
            player.dialogue(new NPCDialogue(STEVE, text));
            return;
        }
        ...
        if (task.equals(SlayerCreature.BOSSES)) {
            player.dialogue(
                    new NPCDialogue(STEVE, "Your new task is to kill " + SlayerCreature.taskName(player, task.getUid()) +
                        ...
                        public void closed(Player player) {
                            player.integerInput("How many would you like to slay? (3-35)", (i) -> {
                                ...
                                player.dialogue(
                                        new NPCDialogue(STEVE, "Excellent. You're now assigned to kill " + SlayerCreature.taskName(player, task.getUid()) + " boss " + i + " times."),
                                        new OptionsDialogue(new Option("Got any tips for me?", () -> player.dialogue(
                                                new PlayerDialogue("Got any tips for me?"),
                                                new NPCDialogue(STEVE, SlayerCreature.getTipFor(task)),
            ...
            if (Config.SLAYER_POINTS.get(player) >= 30) {
                player.dialogue(
                        new NPCDialogue(STEVE, "Excellent, you're doing great. Your new task is to kill " + left + " " + SlayerCreature.taskName(player, task.getUid()) + "."),
                        new OptionsDialogue(
                                new Option("Got any tips for me?", new PlayerDialogue("Got any tips for me?"), new NPCDialogue(STEVE, SlayerCreature.getTipFor(task)), new PlayerDialogue("Great, thanks!")),
                                new Option("Great, thanks!", new PlayerDialogue("Okay, great!")),
                                new Option("No thanks. (Reroll task, costs 30 Slayer points)", new NPCDialogue(STEVE, "Very well."), new ActionDialogue(() -> {
    ...
    static {
        NPCAction.register(STEVE, 1, (player, npc) -> handleInteraction(player, npc, 1));
        NPCAction.register(STEVE, 2, (player, npc) -> handleInteraction(player, npc, 2));
        NPCAction.register(STEVE, 3, (player, npc) -> handleInteraction(player, npc, 3));
        NPCAction.register(STEVE, 4, (player, npc) -> handleInteraction(player, npc, 4));
        NPCAction.register(STEVE, 5, (player, npc) -> handleInteraction(player, npc, 5));
    }
}
