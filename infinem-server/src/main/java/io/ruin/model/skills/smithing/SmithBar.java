...
public enum SmithBar {
    ...
    LOVAKITE(
            ...
            new SmithItem(45, 10.0, Items.SHAYZIEN_GLOVES_1, 1, 1),//Shayzien supply gloves (1)
            new SmithItem(47, 10.0, Items.SHAYZIEN_BOOTS_1, 1, 1),//Shayzien supply boots (1)
            new SmithItem(49, 20.0, Items.SHAYZIEN_HELM_1, 1, 2),//Shayzien supply helm (1)
            new SmithItem(51, 30.0, Items.SHAYZIEN_GREAVES_1, 1, 3),//Shayzien supply greaves (1)
            new SmithItem(53, 40.0, Items.SHAYZIEN_PLATEBODY_1, 1, 4),//Shayzien supply platebody (1)
            new SmithItem(55, 10.0, Items.SHAYZIEN_GLOVES_2, 1, 1),//Shayzien supply gloves (2)
            new SmithItem(57, 10.0, Items.SHAYZIEN_BOOTS_2, 1, 1),//Shayzien supply boots (2)
            new SmithItem(59, 20.0, Items.SHAYZIEN_HELM_2, 1, 2),//Shayzien supply helm (2)
            new SmithItem(61, 30.0, Items.SHAYZIEN_GREAVES_2, 1, 3),//Shayzien supply greaves (2)
            new SmithItem(63, 40.0, Items.SHAYZIEN_PLATEBODY_2, 1, 4),//Shayzien supply platebody (2)
            new SmithItem(65, 10.0, Items.SHAYZIEN_GLOVES_3, 1, 1),//Shayzien supply gloves (3)
            new SmithItem(67, 10.0, Items.SHAYZIEN_BOOTS_3, 1, 1),//Shayzien supply boots (3)
            new SmithItem(69, 20.0, Items.SHAYZIEN_HELM_3, 1, 2),//Shayzien supply helm (3)
            new SmithItem(71, 30.0, Items.SHAYZIEN_GREAVES_3, 1, 3),//Shayzien supply greaves (3)
            new SmithItem(73, 40.0, Items.SHAYZIEN_PLATEBODY_3, 1, 4),//Shayzien supply platebody (3)
            new SmithItem(75, 10.0, Items.SHAYZIEN_GLOVES_4, 1, 1),//Shayzien supply gloves (4)
            new SmithItem(77, 10.0, Items.SHAYZIEN_BOOTS_4, 1, 1),//Shayzien supply boots (4)
            new SmithItem(79, 20.0, Items.SHAYZIEN_HELM_4, 1, 2),//Shayzien supply helm (4)
            new SmithItem(81, 30.0, Items.SHAYZIEN_GREAVES_4, 1, 3),//Shayzien supply greaves (4)
            new SmithItem(83, 40.0, Items.SHAYZIEN_PLATEBODY_4, 1, 4),//Shayzien supply platebody (4)
            new SmithItem(85, 10.0, Items.SHAYZIEN_GLOVES_5, 1, 1),//Shayzien supply gloves (5)
            new SmithItem(87, 10.0, Items.SHAYZIEN_BOOTS_5, 1, 1),//Shayzien supply boots (5)
            new SmithItem(89, 20.0, Items.SHAYZIEN_HELM_5, 1, 2),//Shayzien supply helm (5)
            new SmithItem(91, 30.0, Items.SHAYZIEN_GREAVES_5, 1, 3),//Shayzien supply greaves (5)
            new SmithItem(93, 40.0, Items.SHAYZIEN_PLATEBODY_5, 1, 4),//Shayzien supply platebody (5)
            SmithItem.NONE,
            SmithItem.NONE,
            SmithItem.NONE,
            SmithItem.NONE
    ...
    private SmithItem getSmithItem(int itemId) {
        for (SmithItem item : smithItems) {
            if (item.makeId == itemId) return item;
        }
        return null;
    }
    ...
    private static void open(Player player) {
        ...
        if (bar.smithValue == -1) {
            if (bar.smithItems.length > 0) {
                ...
                for (SmithItem sItem : bar.smithItems) {
                    skillItems.add(new SkillItem(sItem.makeId));
                }
                player.putTemporaryAttribute("SMITH_BAR", bar);
                SkillDialogue.make(player,
                        (p, i) -> {
                            SmithItem smithItem = bar.getSmithItem(i.getId());
                            if (smithItem == null) return;
                            smithItem.make(player, i.getAmount());
                        },
                        skillItems.toArray(new SkillItem[0]));
                return;
            }
            player.dialogue(new MessageDialogue("You should select an item from your inventory and use it on the anvil."));
            return;
    ...
    private static void make(Player player, int itemIndex, int option) {
        SmithItem item = ((SmithBar) player.getTemporaryAttribute("SMITH_BAR")).smithItems[itemIndex];
        if (item == null)
            return;
        int amount = Config.IQ.get(player);
        int maxAmount = player.getInventory().getAmount(((SmithBar) player.getTemporaryAttribute("SMITH_BAR")).itemId) / item.barReq;
