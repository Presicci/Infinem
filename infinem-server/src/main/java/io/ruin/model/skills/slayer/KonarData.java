...
public class KonarData {
    ...
    private enum Task {
        ...
        BLACK_DEMON(30, TaskLocation.TAVERLY_DUNGEON, TaskLocation.BRIMHAVEN_DUNGEON, TaskLocation.CATACOMBS_OF_KOUREND, TaskLocation.CHASM_OF_FIRE),
        ...
        DARK_BEAST(66, TaskLocation.MOURNER_TUNNELS),
        ...
        VAMPYRES(34, TaskLocation.DARKMEYER, TaskLocation.SLEPE),
    ...
    public enum TaskLocation {
        ...
        TaskLocation(int enumId, String name) {
            this.enumId = enumId;
            this.name = name;
        ...
        TaskLocation(int enumId, String name, Bounds... boundaries) {
            this.enumId = enumId;
            this.name = name;
        ...
        TaskLocation(int enumId, String name, int... regionIds) {
            this.enumId = enumId;
            this.name = name;
            this.boundaries = new Bounds[0];
        ...
        TaskLocation(int enumId, String name, int[] regionIds, Bounds... boundaries) {
            this.enumId = enumId;
            this.name = name;
            this.boundaries = boundaries;
            List<Region> regions = new ArrayList<>(regionIds.length);
