...
public enum Impling {
    ...
    BABY(1635, 17, 27, 18, 20, 11238, 0, 30, 1645),
    YOUNG(1636, 22, 32, 20, 22, 11240, 0, 30, 1646),
    GOURMET(1637, 28, 38, 22, 24, 11242, 0, 40 ,1647),
    EARTH(1638, 36, 46, 25, 27, 11244, 0, 30, 1648),
    ...
    NINJA(1643, 74, 84, 52, 125, 11254, 40, 15, 1653),
