...
public enum JumpShortcut {
    LUMBERYARD1(2618, new Position(3308, 3492), 1, 0, "climb-over",
            new Position(3308, 3491), new Position(3308, 3493)),
    SHEEP_JUMP1(12982, new Position(3197, 3276), 1,0, "climb-over",
            new Position(3197, 3278), new Position(3197, 3275)),
    TROLL_W_JUMP1(3748, new Position(2833, 3628), 1,0, "climb",
            new Position(2833, 3627), new Position(2833, 3629)),
    TROLL_E_JUMP1(3748, new Position(2834, 3628), 1,0, "climb",
            new Position(2834, 3627), new Position(2834, 3629)),
    TROLL_FAR_W_JUMP1(3748, new Position(2821, 3635), 1,0, "climb",
            new Position(2820, 3635), new Position(2822, 3635)),
    CABBAGE_JUMP1(7527, new Position(3063, 3282), 1,0, "climb-over",
            new Position(3063, 3281), new Position(3063, 3284)),
    ARDY_JUMP1(993, new Position(2647, 3375), 1,0, "climb-over",
            new Position(2649, 3375), new Position(2646, 3375)),
    FALADOR_FARM1(7527, new Position(3043, 3305), 1,0, "climb-over",
    ...
    SEERS_BEEHIVES1(993, new Position(2761, 3436), 1,0, "climb-over",
            new Position(2761, 3435), new Position(2761, 3438)),
    BARROWS_BROKEN_FENCE1(18411, new Position(3582, 3263), 1, 0, "climb-over",
            new Position(3582, 3264, 0), new Position(3582, 3262, 0)),
    DERANGED_ARCHAEOLOGIST(31842, new Position(3682, 3716), 1, 0, "climb",
            new Position(3682, 3717, 0), new Position(3682, 3715, 0)),
