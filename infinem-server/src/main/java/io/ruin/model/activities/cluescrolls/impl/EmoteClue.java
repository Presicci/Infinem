...
public class EmoteClue extends Clue {
    ...
    private static final Map<Integer, List<Integer>> ITEM_ALTERNATIVES = ImmutableMap.<Integer, List<Integer>>builder()
            ...
            .put(Items.BRONZE_SPEAR, Arrays.asList(Items.BRONZE_SPEAR, Items.BRONZE_SPEAR_P, Items.BRONZE_SPEAR_P_2, Items.BRONZE_SPEAR_P_3, Items.BRONZE_SPEAR_KP))
            ...
            .put(Items.IRON_PLATELEGS, Arrays.asList(Items.IRON_PLATELEGS, Items.IRON_PLATELEGS_T, Items.IRON_PLATELEGS_G))
            ...
            .put(Items.ADAMANT_PLATEBODY, Arrays.asList(Items.ADAMANT_PLATEBODY, Items.ADAMANT_PLATEBODY_T, Items.ADAMANT_PLATEBODY_G))
            .put(Items.ADAMANT_PLATELEGS, Arrays.asList(Items.ADAMANT_PLATELEGS, Items.ADAMANT_PLATELEGS_T, Items.ADAMANT_PLATELEGS_G))
            .put(Items.ADAMANT_PLATESKIRT, Arrays.asList(Items.ADAMANT_PLATESKIRT, Items.ADAMANT_PLATESKIRT_T, Items.ADAMANT_PLATESKIRT_G))
            ...
            .put(Items.RUNE_FULL_HELM, Arrays.asList(Items.RUNE_FULL_HELM, Items.RUNE_FULL_HELM_T, Items.RUNE_FULL_HELM_G))
            .put(Items.RUNE_PLATELEGS, Arrays.asList(Items.RUNE_PLATELEGS, Items.RUNE_PLATELEGS_T, Items.RUNE_PLATELEGS_G))
            ...
            .put(Items.GUTHANS_CHAINSKIRT, Arrays.asList(Items.GUTHANS_CHAINSKIRT, Items.GUTHANS_CHAINSKIRT_25, Items.GUTHANS_CHAINSKIRT_50, Items.GUTHANS_CHAINSKIRT_75, Items.GUTHANS_CHAINSKIRT_100))
            .put(Items.GUTHANS_WARSPEAR, Arrays.asList(Items.GUTHANS_WARSPEAR, Items.GUTHANS_WARSPEAR_25, Items.GUTHANS_WARSPEAR_50, Items.GUTHANS_WARSPEAR_75, Items.GUTHANS_WARSPEAR_100))
            .put(Items.DHAROKS_HELM, Arrays.asList(Items.DHAROKS_HELM, Items.DHAROKS_HELM_25, Items.DHAROKS_HELM_50, Items.DHAROKS_HELM_75, Items.DHAROKS_HELM_100))
            .put(Items.DHAROKS_PLATEBODY, Arrays.asList(Items.DHAROKS_PLATEBODY, Items.DHAROKS_PLATEBODY_25, Items.DHAROKS_PLATEBODY_50, Items.DHAROKS_PLATEBODY_75, Items.DHAROKS_PLATEBODY_100))
            .put(Items.DHAROKS_PLATELEGS, Arrays.asList(Items.DHAROKS_PLATELEGS, Items.DHAROKS_PLATELEGS_25, Items.DHAROKS_PLATELEGS_50, Items.DHAROKS_PLATELEGS_75, Items.DHAROKS_PLATELEGS_100))
            .put(Items.DHAROKS_GREATAXE, Arrays.asList(Items.DHAROKS_GREATAXE, Items.DHAROKS_GREATAXE_25, Items.DHAROKS_GREATAXE_50, Items.DHAROKS_GREATAXE_75, Items.DHAROKS_GREATAXE_100))
            .put(Items.KARILS_COIF, Arrays.asList(Items.KARILS_COIF, Items.KARILS_COIF_25, Items.KARILS_COIF_50, Items.KARILS_COIF_75, Items.KARILS_COIF_100))
            .put(Items.KARILS_LEATHERTOP, Arrays.asList(Items.KARILS_LEATHERTOP, Items.KARILS_LEATHERTOP_25, Items.KARILS_LEATHERTOP_50, Items.KARILS_LEATHERTOP_75, Items.KARILS_LEATHERTOP_100))
            .put(Items.KARILS_LEATHERSKIRT, Arrays.asList(Items.KARILS_LEATHERSKIRT, Items.KARILS_LEATHERSKIRT_25, Items.KARILS_LEATHERSKIRT_50, Items.KARILS_LEATHERSKIRT_75, Items.KARILS_LEATHERSKIRT_100))
            .put(Items.KARILS_CROSSBOW, Arrays.asList(Items.KARILS_CROSSBOW, Items.KARILS_CROSSBOW_25, Items.KARILS_CROSSBOW_50, Items.KARILS_CROSSBOW_75, Items.KARILS_CROSSBOW_100))
            .put(Items.TORAGS_HELM, Arrays.asList(Items.TORAGS_HELM, Items.TORAGS_HELM_25, Items.TORAGS_HELM_50, Items.TORAGS_HELM_75, Items.TORAGS_HELM_100))
            .put(Items.TORAGS_PLATEBODY, Arrays.asList(Items.TORAGS_PLATEBODY, Items.TORAGS_PLATEBODY_25, Items.TORAGS_PLATEBODY_50, Items.TORAGS_PLATEBODY_75, Items.TORAGS_PLATEBODY_100))
            .put(Items.TORAGS_PLATELEGS, Arrays.asList(Items.TORAGS_PLATELEGS, Items.TORAGS_PLATELEGS_25, Items.TORAGS_PLATELEGS_50, Items.TORAGS_PLATELEGS_75, Items.TORAGS_PLATELEGS_100))
            .put(Items.TORAGS_HAMMERS, Arrays.asList(Items.TORAGS_HAMMERS, Items.TORAGS_HAMMERS_25, Items.TORAGS_HAMMERS_50, Items.TORAGS_HAMMERS_75, Items.TORAGS_HAMMERS_100))
            .put(Items.VERACS_HELM, Arrays.asList(Items.VERACS_HELM, Items.VERACS_HELM_25, Items.VERACS_HELM_50, Items.VERACS_HELM_75, Items.VERACS_HELM_100))
            .put(Items.VERACS_BRASSARD, Arrays.asList(Items.VERACS_BRASSARD, Items.VERACS_BRASSARD_25, Items.VERACS_BRASSARD_50, Items.VERACS_BRASSARD_75, Items.VERACS_BRASSARD_100))
            .put(Items.VERACS_PLATESKIRT, Arrays.asList(Items.VERACS_PLATESKIRT, Items.VERACS_PLATESKIRT_25, Items.VERACS_PLATESKIRT_50, Items.VERACS_PLATESKIRT_75, Items.VERACS_PLATESKIRT_100))
            .put(Items.VERACS_FLAIL, Arrays.asList(Items.VERACS_FLAIL, Items.VERACS_FLAIL_25, Items.VERACS_FLAIL_50, Items.VERACS_FLAIL_75, Items.VERACS_FLAIL_100))
            .put(Items.AHRIMS_HOOD, Arrays.asList(Items.AHRIMS_HOOD, Items.AHRIMS_HOOD_25, Items.AHRIMS_HOOD_50, Items.AHRIMS_HOOD_75, Items.AHRIMS_HOOD_100))
            .put(Items.AHRIMS_ROBETOP, Arrays.asList(Items.AHRIMS_ROBETOP, Items.AHRIMS_ROBETOP_25, Items.AHRIMS_ROBETOP_50, Items.AHRIMS_ROBETOP_75, Items.AHRIMS_ROBETOP_100))
            .put(Items.AHRIMS_ROBESKIRT, Arrays.asList(Items.AHRIMS_ROBESKIRT, Items.AHRIMS_ROBESKIRT_25, Items.AHRIMS_ROBESKIRT_50, Items.AHRIMS_ROBESKIRT_75, Items.AHRIMS_ROBESKIRT_100))
            .put(Items.AHRIMS_STAFF, Arrays.asList(Items.AHRIMS_STAFF, Items.AHRIMS_STAFF_25, Items.AHRIMS_STAFF_50, Items.AHRIMS_STAFF_75, Items.AHRIMS_STAFF_100))
            .build();
    ...
    public enum EmoteClueData {
        ...
        AL_KHARID_MINE_2("Headbang in the mine north of Al Kharid. Equip a desert shirt, leather gloves and leather boots.",
                Collections.singletonList(TabEmote.HEAD_BANG), new Bounds(3292, 3271, 3307, 3296, 0),
        ...
        SHADOW_DUNGEON("Cheer in the Shadow dungeon. Equip a rune crossbow, climbing boots and any mitre.",
                Collections.singletonList(TabEmote.CHEER), new Bounds(2626, 5067, 2633, 5074, 0),
                Arrays.asList(Items.RUNE_CROSSBOW, Items.CLIMBING_BOOTS, Items.SARADOMIN_MITRE), ClueType.ELITE, Config.STASH_UNITS[73], 29027),
