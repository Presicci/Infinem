package io.ruin.model.activities.combat.gauntlet.monsters;

import io.ruin.model.activities.combat.gauntlet.GauntletRoom;
import io.ruin.model.activities.combat.gauntlet.GauntletType;
...
public enum GauntletMonster {
     ...
     * @return
     */
    public static List<GauntletMonster> getRandomSpawn(GauntletRoom room, GauntletType type) {
