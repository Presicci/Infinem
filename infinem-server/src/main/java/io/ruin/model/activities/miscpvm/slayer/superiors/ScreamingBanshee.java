 ...
 */
public class ScreamingBanshee extends Superior {

    private static final StatType[] DRAIN = { StatType.Attack, StatType.Strength, StatType.Defence, StatType.Ranged, StatType.Magic, StatType.Prayer, StatType.Agility};
