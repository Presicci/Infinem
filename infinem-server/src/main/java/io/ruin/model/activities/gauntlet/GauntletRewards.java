...
public class GauntletRewards {
    private static Map<GauntletRewardRarity, List<Item>> possibleLoot;//= Maps.newConcurrentMap();

    static {
        try {
            possibleLoot.put(GauntletRewardRarity.COMMON, Arrays.asList(
            ...
            possibleLoot.put(GauntletRewardRarity.RARE, Arrays.asList(
                    new Item(4207, 1),
                    new Item(23956, 1),
                    new Item(23953, 1)));

            possibleLoot.put(GauntletRewardRarity.VERY_RARE, Arrays.asList(
                    new Item(23997, 1),
                    new Item(33719, 1),
                    new Item(23757, 1)));
        }
    ...
    public static Item rollForItem(Player player) {
        List<Item> itemList = possibleLoot.get(GauntletRewardRarity.COMMON);
    ...
    public static void openChest(Player player) {
        ...
        if (randomother == 5) {
            possibleLoot.get(GauntletRewardRarity.VERY_RARE);
        } else if (randomseed == 5) {
            possibleLoot.get(GauntletRewardRarity.RARE);
        }
        //    }
