...
public enum ClickSetting {
    ...
    DROP_VIEWER_EXAMINE(8, 2, 390, Config.DROP_VIEWER_EXAMINE::toggle),
    BESTIARY_KC(8, 4, 392, Config.BESTIARY_KC::toggle),
    BESTIARY_NEW_ENTRY(8, 5, 393, Config.BESTIARY_NEW_ENTRY::toggle),
    TRANSMOG_POPUP(8, 7, 395, Config.TRANSMOG_POPUP::toggle),
    INFO_BROADCAST(8, 9, 397, Config.INFORMATION_BROADCASTS::toggle),
    SKILL_BROADCAST(8, 10, 398, Config.SKILLING_BROADCASTS::toggle),
    DROP_BROADCAST(8, 11, 399, Config.DROP_BROADCASTS::toggle),
    FRIEND_BROADCAST(8, 12, 400, Config.FRIEND_BROADCASTS::toggle),
    ACTIVITY_SPOTLIGHT_BROADCAST(8, 13, 401, Config.ACTIVITY_SPOTLIGHT_BROADCAST::toggle);
