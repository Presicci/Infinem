...
public class Config {
   ...
   public static final Config EMOTES = varp(313, true);
    ...
    public static final Config SPELL_RESIZING = varpbit(6548, true);
    ...
    public static final Config CHARACTER_CREATOR_GENDER = varpbit(14021, false);
    ...
    public static final Config SHADOW_DUNGEON_ENTRANCE = varpbit(15152, false).defaultValue(1);   // Lets players see the shadow dungeon entrance
    ...
    public int removeBit(Player player, int bit) {
        int value = get(player) & ~(1 << bit);
        set(player, value);
        return value;
    }
