...
public class DropViewerCustomEntries {
    ...
    public static final List<DropViewerEntry> ENTRIES = Stream.of(
            ...
            new DropViewerEntry("Grubby Chest (Food)", GrubbyChest.FOOD),
            new DropViewerEntry("Grubby Chest (Potion)", GrubbyChest.POTION),
            new DropViewerEntry("Grubby Chest", GrubbyChest.MAIN),
