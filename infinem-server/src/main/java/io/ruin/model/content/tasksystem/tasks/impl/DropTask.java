...
public enum DropTask {
    ...
    FIGHTER_TORSO(597, Items.FIGHTER_TORSO),
    ZENYTE_SHARD(608, Items.ZENYTE_SHARD),
    HEAVY_FRAME(609, Items.HEAVY_FRAME),
    KRAKEN_TENTACLE(610, Items.KRAKEN_TENTACLE),
    ...
    SERPENTINE_VISAGE(813, Items.SERPENTINE_VISAGE),
    TANZANITE_FANG(814, Items.TANZANITE_FANG),
    MAGIC_FANG(815, Items.MAGIC_FANG),
    MUTAGEN(825, Items.MAGMA_MUTAGEN, Items.TANZANITE_MUTAGEN),
    DRAGONSTONE_ARMOUR(826, 24034, 24037, 24040, 24043, 24046),
