...
public class GoblinBook extends ChapteredBook {
    ...
    public String[] getContent() {
        return new String[]{
                ...
                "<col=800000> The end of the war and the prophecy </col> <br> " +
                        ...
                        " <br> " +
                        "At last all goblin tribes have big battle on plain of mud. Battle last many days and many goblins die, battle is glorious! But goblin corpses cover the ground and it look like all die. <br> " +
                        " <br> " +
                        ...
                        " <br> " +
                        "This is the word of Big High War God: Battle is indeed glorious and goblins are soldiers, but if there too much battle all goblins die! No more must goblin fight against goblin or tribe against tribe. Goblins must find other enemies to fight, but not fight each other! <br> " +
                        " <br> " +
                        "And this is the word of Big High War God: Today I cannot lead you, but someday I will send a new Commander to lead you. Under new Commander goblins will conquer all of Gielinor, every race and every god! And then Big High War God will return and sit on throne of bronze and rule over all. War will end in victory and victory will last forever! <br> " +
                        "So leaders of tribes stop battle. And on plain of mud all tribes build temple to Big High War God and offer sacrifices."
                /*"<col=800000> The Creation of the <col=800000>Goblins </col>   <br>   " +
                        "In beginning all gods have big war. Each god find army to fight for him.  <br>  "+
                        "  <br>  "+
                        "Big High War God not have army. Big High War God go to short-beardy-people and ask, Will you fight in " +
                        "my army? But beardy-short-people say, No, we fight for god of shiny light.  <br> " +
                        "  <br>  " +
                        " Then Big High War God go to demons and ask, Will you fight in my army? But demons say, No, we fight for God of Dark Fire.  <br>  "
                        ...
                        + "Dark Fire, and other tribes to other gods. But most still worship Big High War God who created them! ",

                "<col=800000> The Several Commandments </col>   <br>   "
                        + "These are commandments of Big High War God! Obey all commandments all time or "
                        ...
                        + "God. Doubters must die! Not to make own plans. Thinkers must die!  <br>   <br>   <br>   <br>   <br> ",

                "<col=800000> The end of the war and the prophecy </col>  "
    ...
    private static final String CONTEXT =
            ...
            + "for us too! So Big High War God take some tribes and sell them, one to God of Shiny Light and one to God of "
            + "Dark Fire, and other tribes to other gods. But most still worship Big High War God who created them! "
            + "<col=800000> The Several Commandments </col> "
            + "These are commandments of Big High War God! Obey all commandments all time or "
            + "Big High War God kill you very bad!!  <br>  Always to slay enemies of Big High War God. Enemies must die! "
            + "Not to run from battle. Cowards must die! Not to show mercy. Merciful must die! Not to doubt Big High War "
            + "God. Doubters must die! Not to make own plans. Thinkers must die!  <br>  "
            + "<col=800000>The end of the war and <col=800000>the prophecy</col>"
            + " <br>  The war of gods last many lifetimes. Battle is glorious and many heroes live and die! Then all gods "
            + "leave world, leave their armies behind. But goblins still soldiers, still fight! Goblins fight against tall"
            + " people with keen blades. But tall people build cities with walls, they not want to fight. They not true "
            + "soldiers like goblins! But now goblins not have enough to eat, and have no commanders to tell them who to "
