...
public enum AreaShopItem {
    ...
    NINJA_GREEGREE(Items.NINJA_MONKEY_GREEGREE, TaskArea.KANDARIN, AreaTaskTier.EASY, 1000),
    ...
    KARAMJAN_MONKEY_GREEGREE(Items.KARAMJAN_MONKEY_GREEGREE, TaskArea.KARAMJA, AreaTaskTier.EASY, 500),
    ...
    DWARVEN_ROCK_CAKE(Items.DWARVEN_ROCK_CAKE, TaskArea.MISTHALIN, AreaTaskTier.MEDIUM, 100),
    ...
    GHOSTLY_HOOD(Items.GHOSTLY_HOOD, TaskArea.MORYTANIA, AreaTaskTier.EASY, 300),
    GHOSTLY_CLOAK(Items.GHOSTLY_CLOAK, TaskArea.MORYTANIA, AreaTaskTier.EASY, 300),
    GHOSTLY_ROBE(Items.GHOSTLY_ROBE_TOP, TaskArea.MORYTANIA, AreaTaskTier.EASY, 500),
    GHOSTLY_ROBE_B(Items.GHOSTLY_ROBE_BOTTOM, TaskArea.MORYTANIA, AreaTaskTier.EASY, 500),
    GHOSTLY_GLOVES(Items.GHOSTLY_GLOVES, TaskArea.MORYTANIA, AreaTaskTier.EASY, 250),
    GHOSTLY_BOOTS(Items.GHOSTLY_BOOTS, TaskArea.MORYTANIA, AreaTaskTier.EASY, 250),
