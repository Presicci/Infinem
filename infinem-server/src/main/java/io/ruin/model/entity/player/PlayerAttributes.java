...
public abstract class PlayerAttributes extends Entity {
    ...
    @Expose public int pickpocketCaveGoblin;
    ...
    @Expose public int harvestedNightshade;
    ...
    @Expose public int grownDragonfruit;
    ...
    @Expose public int grownTeak;
    @Expose public int grownMahogany;
    ...
    @Expose public int grownCrystalTree;

    @Expose public int grownGrapeVines;

    @Expose public int grownGiantSeaweed;
