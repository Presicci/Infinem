...
public class Mac {
    ...
    static {
        ...
        NPCAction.register(1053, "talk-to", (player, npc) -> {
        ...
        NPCAction.register(1053, "buy-capes", (p, n) -> ShopManager.openIfExists(p, MAC_SHOP_UUID));
        NPCAction.register(1053, "buy-capes 2", (p, n) -> ShopManager.openIfExists(p, MAC_SHOP2_UUID));
        NPCAction.register(1053, "buy-master capes", (p, n) -> ShopManager.openIfExists(p, MAC_MASTER_UUID));
    }
